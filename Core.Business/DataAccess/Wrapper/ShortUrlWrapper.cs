...
{
    public class ShortUrlWrapper : UniversalObject
    {
        private readonly string _module = "Core.Business.DataAccess.Wrapper.ShortUrl";
        ...
        public ShortUrl objWrapperClass = new ShortUrl();
        private ShortUrlDataMapper objShortUrlDataMapper = new ShortUrlDataMapper();
        ...
        public bool GetRecordById(int id)
        {
            ...
            try
            {
                ...
                sqlCommand.CommandText = ShortUrlStoredProcedures.ShortUrlGetRecordById;
                sqlCommand.CommandType = CommandType.StoredProcedure;
                sqlCommand.CommandTimeout = 0;
                sqlCommand.Connection = this.Connection;
                sqlCommand.Parameters.AddWithValue(ShortUrlDBFields.ID, id);
                sqlDataReader = sqlCommand.ExecuteReader();
                if (sqlDataReader.Read())
                {
                    objWrapperClass = objShortUrlDataMapper.GetDetails(sqlDataReader);
                    return true;
                }
                else
                    return false;
        ...
        public bool GetRecordByValue(string fieldName, string value)
        {
            ...
            try
            {
                if (this.Connection == null)
                    this.Connection = dbClass.GetSqlConnection();
                SqlCommand sqlCommand = new SqlCommand();
                sqlCommand.CommandText = ShortUrlStoredProcedures.GetShortUrlRecordByValue;
                sqlCommand.CommandType = CommandType.StoredProcedure;
                sqlCommand.CommandTimeout = 0;
                sqlCommand.Connection = this.Connection;
        ...
        public bool GetRecordByValue(string[] fieldNames, string[] values)
        {
            ...
            try
            {
                if (this.Connection == null)
                    this.Connection = dbClass.GetSqlConnection();
                SqlCommand sqlCommand = new SqlCommand();
                sqlCommand.CommandText = ShortUrlStoredProcedures.GetShortUrlRecordByValueArray;
                sqlCommand.CommandType = CommandType.StoredProcedure;
                sqlCommand.CommandTimeout = 0;
                sqlCommand.Connection = this.Connection;
        ...
        public bool Save(ref Dictionary<string, Command> commandList, ref int commandCounter)
        {
            try
            {
                ...
                {
                    Command command = new Command(ShortUrlStoredProcedures.ShortUrlSAVE, CommandType.StoredProcedure);
                    command.AddParameter(ShortUrlDBFields.IU_Flag, "I", DataAccessLayer.DataAccess.DataType.Char, 0, ParameterDirection.Input);
                    command.AddParameter(ShortUrlDBFields.ID, objWrapperClass.ID, DataAccessLayer.DataAccess.DataType.Number, 0, ParameterDirection.Input);
                    command.AddParameter(ShortUrlDBFields.KeyValue, objWrapperClass.KeyValue, DataAccessLayer.DataAccess.DataType.NVarChar, 0, ParameterDirection.Input);
                    command.AddParameter(ShortUrlDBFields.URLString, objWrapperClass.URLString, DataAccessLayer.DataAccess.DataType.NVarChar, 0, ParameterDirection.Input);
                    //command.AddParameter(ShortUrlDBFields.StatusId, objWrapperClass.StatusId, DataAccessLayer.DataAccess.DataType.Varchar2, 0, ParameterDirection.Input);
                    //command.AddParameter(ShortUrlDBFields.CreatedDate, objWrapperClass.CreatedDate, DataAccessLayer.DataAccess.DataType.DateTime, 0, ParameterDirection.Input);
                    //command.AddParameter(ShortUrlDBFields.UpdatedDate, objWrapperClass.UpdatedDate, DataAccessLayer.DataAccess.DataType.DateTime, 0, ParameterDirection.Input);


                    command.Name = ShortUrlStoredProcedures.ShortUrlSAVE + commandCounter.ToString();
                    commandCounter++;
        ...
        public bool Update(ref Dictionary<string, Command> commandList, ref int commandCounter)
        {
            try
            {
                ...
                command.AddParameter(ShortUrlDBFields.IU_Flag, "U", DataAccessLayer.DataAccess.DataType.Char, 0, ParameterDirection.Input);
                command.AddParameter(ShortUrlDBFields.ID, objWrapperClass.ID, DataAccessLayer.DataAccess.DataType.Number, 0, ParameterDirection.Input);
                command.AddParameter(ShortUrlDBFields.KeyValue, objWrapperClass.KeyValue, DataAccessLayer.DataAccess.DataType.NVarChar, 0, ParameterDirection.Input);
                command.AddParameter(ShortUrlDBFields.URLString, objWrapperClass.URLString, DataAccessLayer.DataAccess.DataType.NVarChar, 0, ParameterDirection.Input);
                //command.AddParameter(ShortUrlDBFields.StatusId, objWrapperClass.StatusId, DataAccessLayer.DataAccess.DataType.Varchar2, 0, ParameterDirection.Input);
        ...
        public bool Delete(ref Dictionary<string, Command> commandList, ref int commandCounter)
        {
            try
            {
                ...
                command.AddParameter("@TableName", "ShortUrl", DataAccessLayer.DataAccess.DataType.Varchar, 0, ParameterDirection.Input);
                ...
                command.Name = "DeleteShortUrl" + commandCounter.ToString();
                commandCounter++;
                commandList.Add(command.Name, command);
        ...
        public bool GetShortURLKey(string URLString)
        {
            ...
            try
            {
                if (this.Connection == null)
                    this.Connection = dbClass.GetSqlConnection();
                SqlCommand sqlCommand = new SqlCommand();
                sqlCommand.CommandText = ShortUrlStoredProcedures.Get_SHORTURL_Key;
                sqlCommand.CommandType = CommandType.StoredProcedure;
                sqlCommand.Connection = this.Connection;
                sqlCommand.Parameters.AddWithValue(ShortUrlDBFields.URLString, URLString);
                sqlDataReader = sqlCommand.ExecuteReader();
                if (sqlDataReader.Read())
                {
                    objWrapperClass = objShortUrlDataMapper.GetDetails(sqlDataReader);
    ...
    public class ShortUrlWrapperColletion : UniversalCollection
    {
        private readonly string _module = "ShortUrl";
        private SqlConnection Connection;
        private List<ShortUrl> _Items = new List<ShortUrl>();
        public List<ShortUrl> Items
        ...
        {
            if (createDataSet)
                return GetDataSetForQuery(ShortUrlStoredProcedures.GetShortUrlRecords);
            else
                return GetCollectionForQuery(ShortUrlStoredProcedures.GetShortUrlRecords);
        }
        public bool GetRecords(bool createDataSet, string[,] sortFields, bool isParameter)
        {
            ...
            ObjSqlParameter.ParameterName = ShortUrlStoredProcedures.SortingString;
            ObjSqlParameter.Value = _SortingString;
            sqlParameterCollection.Add(ObjSqlParameter);

            if (createDataSet)
                return GetDataSetForQueryParameter(ShortUrlStoredProcedures.GetShortUrlRecords, sqlParameterCollection);
            else
                return GetDataSetForQueryParameter(ShortUrlStoredProcedures.GetShortUrlRecords, sqlParameterCollection);
        }
        public bool GetRecords(bool createDataSet, string[,] sortFields, bool isParameter, string fieldName, string fieldValue)
        {
            ...
            return GetCollectionForQueryWithParameters(ShortUrlStoredProcedures.GetShortUrlRecordByValue, Fieldsname, Values);
        }
        ...
        private bool GetCollectionForQueryWithParameters(string sqlQuery, string[] fieldNames, string[] values)
        {
            ...
            try
            {
                ...
                while (_Dtr.Read())
                {
                    ShortUrlDataMapper objDataMapper = new ShortUrlDataMapper();
        ...
        public bool Search(string fieldName, string fieldValue, string[,] sortString)
        {
            try
            {
                ...
                GetCollectionForQueryWithParameter(ShortUrlStoredProcedures.ShortUrlSearch, sqlParameterCollection);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public bool Search(string fieldName, string fieldValue, bool createDataSet, string[,] sortFields)
        {
            ...
            try
            {
                ...
                if (createDataSet)
                    return GetDataSetForQueryParameter(ShortUrlStoredProcedures.ShortUrlSearchByValue, sqlParameterCollection);
                else
                    return GetDataSetForQueryParameter(ShortUrlStoredProcedures.ShortUrlSearchByValue, sqlParameterCollection);
        ...
        public bool Search(string[] fieldName, string[] fieldValue, bool createDataSet, string[,] sortFields)
        {
            ...
            try
            {
                ...
                if (createDataSet)
                    return GetDataSetForQueryParameter(ShortUrlStoredProcedures.ShortUrlSearchByValueArray, sqlParameterCollection);
                else
                    return GetDataSetForQueryParameter(ShortUrlStoredProcedures.ShortUrlSearchByValueArray, sqlParameterCollection);
        ...
        private bool GetDataSetForQuery(string sqlQuery)
        {
            try
            {
                DataSet _DtsUsers = new DataSet("ShortUrl");
        ...
        private bool GetCollectionForQuery(string sqlQuery)
        {
            ...
            try
            {
                ...
                while (_Dtr.Read())
                {
                    ShortUrlDataMapper objShortUrlDataMapper = new ShortUrlDataMapper();
                    this.Items.Add(objShortUrlDataMapper.GetDetails(_Dtr));
                }
                return true;
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                for (int i = 0; i < this.Items.Count; i++)
                {
                    if (this.Items[i].ObjectChanged == true)
                    {
                        ...
                        objShortUrlWrapper.Save(ref subCommands, ref commandCounter);
        ...
        public bool Delete(string ids, ref Dictionary<string, Command> commandList, ref int commandCounter)
        {
            ...
            {
                Command command = new Command("SP_MASTERS_DELETE", CommandType.StoredProcedure);
                command.AddParameter("@TableName", ShortUrlDBFields.TableNameVal, DataAccessLayer.DataAccess.DataType.Varchar, 0, ParameterDirection.Input);
                command.AddParameter("@PrimaryKeyColumn", ShortUrlDBFields.ID, DataAccessLayer.DataAccess.DataType.Varchar, 0, ParameterDirection.Input);
                command.AddParameter("@IDs", ids, DataAccessLayer.DataAccess.DataType.Varchar, 0, ParameterDirection.Input);
                command.Name = "Delete" + ShortUrlDBFields.TableNameVal + commandCounter.ToString();
                commandCounter++;
                commandList.Add(command.Name, command);
